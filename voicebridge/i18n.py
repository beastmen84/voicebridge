...
TRANSLATIONS: dict[str, dict[str, str]] = {
    UI_LANGUAGE_EN: {
        ...
        "manual.missing.message": "Could not find Manual.html or Manual.md next to the application.",
        ...
        "local_voices.tab.datasets": "Datasets",
    ...
    UI_LANGUAGE_IT: {
        ...
        "manual.missing.message": "Impossibile trovare Manual.html o Manual.md accanto all'applicazione.",
        "nav.dashboard": "Dashboard",
        "nav.tts": "Text to Speech",
