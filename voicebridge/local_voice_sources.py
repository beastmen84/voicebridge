...
from voicebridge.json_schemas import VOICE_MODELING_TRAINING_RESULT_JSON_KIND, app_json_version_supported
...
def local_voice_from_training_result(result_path: str | Path) -> LocalVoiceSource:
    ...
    if not app_json_version_supported(result, kind=VOICE_MODELING_TRAINING_RESULT_JSON_KIND):
