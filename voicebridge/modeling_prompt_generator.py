...
MODELING_PROMPT_CORPUS_VERSION = "1.1"
...
MODELING_PROMPT_CORPUS_EXTENSIONS: dict[str, ModelingPromptCorpus] = {
    "it": {
        ...
        "medium": (
            ...
            "Una pausa breve tra due idee rende il parlato piu' chiaro senza sembrare artificiale.",
        ...
        "question": (
            ...
            "Il ritmo e' costante anche quando la frase diventa piu' lunga?",
        ),
        "numbers": (
            "Sul calendario segno 4 incontri, 18 minuti di prova e 32 righe lette.",
            "Il volume resta vicino al 70%, mentre la distanza e' circa 20 centimetri.",
        ...
        "punctuation": (
            "Ottimo: la frase e' breve, chiara e ben scandita.",
            "Aspetta un secondo, respira, poi continua con naturalezza.",
            "Non serve correre; meglio leggere bene, con calma.",
            "Se il rumore aumenta, fermati! Riprendi solo quando la stanza e' silenziosa.",
    ...
    "es": {
        "short": (
            ...
            "Camino despacio y mantengo la misma distancia al microfono.",
            "El cuaderno guarda notas breves y ordenadas.",
            "La voz sigue suave aunque la frase avance mas rapido.",
            "Cierro la puerta sin ruido y vuelvo a leer.",
        ),
        "medium": (
            "Cada grabacion debe tener un inicio limpio, una frase completa y un final sin ruidos.",
            "Si una palabra resulta dificil, la digo con naturalidad en lugar de subir mucho el volumen.",
            "El texto alterna descripciones simples, acciones cotidianas y cambios de ritmo controlados.",
            "Una pausa breve entre dos ideas hace que el habla sea mas clara sin sonar artificial.",
            "Leo con atencion, pero dejo que la voz tenga un movimiento ligero y espontaneo.",
        ),
        "question": (
            ...
            "Podemos hacer que la ultima palabra sea clara sin exagerarla?",
            "El ritmo se mantiene constante cuando la frase se hace mas larga?",
        ),
        "numbers": (
            "En el calendario marco 4 reuniones, 18 minutos de prueba y 32 lineas leidas.",
            "El volumen queda cerca del 70%, y la distancia es de unos 20 centimetros.",
            "Preparo 5 tarjetas, descarto 1 y conservo 14 ejemplos utiles.",
            "La segunda clip dura 42 segundos e incluye 6 pausas naturales.",
            "A las 9:30 grabo 3 frases cortas y 2 mas largas.",
        ),
        "names": (
            "Irene escucha a Mateo y luego pide a Bianca que revise el texto.",
            "Luca, Gianni y Serena leen por turnos sin cambiar el tono.",
            "Elisa encuentra a Fabio junto a la libreria y le entrega una carpeta.",
            "Roberto saluda a Ana, ajusta el microfono y repite la frase.",
            "Clara y Simon eligen un ejemplo claro para el nuevo dataset.",
        ),
        "punctuation": (
            "Excelente: la frase es breve, clara y bien marcada.",
            "Espera un segundo, respira y luego continua con naturalidad.",
            "No hace falta correr; es mejor leer bien y con calma.",
            "Si aumenta el ruido, detente! Continua solo cuando la sala este tranquila.",
            "Nota: la puntuacion guia el ritmo, pero no debe leerse como texto.",
        ),
    },
    "fr": {
        "short": (
            "La tasse reste sur l'etagere pendant que je prepare la piece.",
            "Je marche lentement et je garde la meme distance du micro.",
            "Le carnet contient des notes courtes et bien rangees.",
            "La voix reste douce meme quand la phrase accelere.",
            "Je ferme la porte sans bruit et je reprends la lecture.",
        ),
        "medium": (
            "Chaque enregistrement doit commencer proprement, contenir une phrase complete et finir sans bruit.",
            "Si un mot semble difficile, je le prononce naturellement au lieu de monter le volume.",
            "Le texte alterne des descriptions simples, des gestes quotidiens et des changements de rythme controles.",
            "Une courte pause entre deux idees rend la parole plus claire sans paraitre artificielle.",
            "Je lis avec attention, tout en laissant la voix bouger de facon legere et naturelle.",
        ),
        "question": (
            "Veux-tu repeter la phrase si tu entends une toux ou un froissement?",
            "Ce ton convient-il a une histoire simple?",
            "As-tu laisse assez de silence avant de commencer a parler?",
            "Peut-on rendre le dernier mot clair sans l'exagerer?",
        ...
        "numbers": (
            ...
            "Le volume reste pres de 70%, et la distance est d'environ 20 centimetres.",
            "Je prepare 5 fiches, j'en retire 1 et je garde 14 exemples utiles.",
            "La deuxieme clip dure 42 secondes et contient 6 pauses naturelles.",
            "A 9:30 j'enregistre 3 phrases courtes et 2 plus longues.",
        ),
        "names": (
            "Irene ecoute Mateo, puis demande a Bianca de verifier le texte.",
            "Luca, Gianni et Serena lisent a tour de role sans changer de ton.",
            "Elisa retrouve Fabio pres de la bibliotheque et lui donne un dossier.",
            "Robert salue Anna, regle le micro et reprend la phrase.",
            "Clara et Simon choisissent un exemple clair pour le nouveau dataset.",
        ),
        "punctuation": (
            "Excellent: la phrase est courte, claire et bien rythmee.",
            "Attends une seconde, respire, puis continue naturellement.",
            "Inutile de se presser; mieux vaut lire clairement et calmement.",
            "Si le bruit augmente, arrete-toi! Reprends seulement quand la piece est calme.",
            "Note: la ponctuation guide le rythme, mais elle ne doit pas etre lue comme du texte.",
        ),
    },
    "de": {
        "short": (
            "Die Tasse bleibt im Regal, waehrend ich den Raum vorbereite.",
            "Ich gehe langsam und halte den gleichen Abstand zum Mikrofon.",
            "Das Heft enthaelt kurze und geordnete Notizen.",
            "Die Stimme bleibt weich, auch wenn der Satz schneller wird.",
            "Ich schliesse die Tuer leise und lese weiter.",
        ),
        "medium": (
            "Jede Aufnahme braucht einen sauberen Anfang, einen vollstaendigen Satz und ein Ende ohne Stoergeraeusche.",
            "Wenn ein Wort schwierig wirkt, spreche ich es natuerlich statt die Lautstaerke stark zu erhoehen.",
            "Der Text wechselt einfache Beschreibungen, alltaegliche Handlungen und kontrollierte Rhythmuswechsel.",
            "Eine kurze Pause zwischen zwei Gedanken macht die Sprache klarer, ohne kuenstlich zu klingen.",
            "Ich lese aufmerksam, lasse der Stimme aber eine leichte und natuerliche Bewegung.",
        ),
        "question": (
            "Moechtest du den Satz wiederholen, wenn du Husten oder Rascheln hoerst?",
            "Passt dieser Ton zu einer einfachen Erzaehlung?",
            "Hast du vor dem Sprechen genug Stille gelassen?",
            "Koennen wir das letzte Wort klar machen, ohne es zu uebertreiben?",
            "Bleibt der Rhythmus stabil, wenn der Satz laenger wird?",
        ),
        "numbers": (
            "Im Kalender markiere ich 4 Treffen, 18 Minuten Test und 32 gelesene Zeilen.",
            "Die Lautstaerke bleibt nahe bei 70%, und der Abstand betraegt etwa 20 Zentimeter.",
            "Ich bereite 5 Karten vor, verwerfe 1 und behalte 14 nuetzliche Beispiele.",
            "Der zweite Clip dauert 42 Sekunden und enthaelt 6 natuerliche Pausen.",
            "Um 9:30 nehme ich 3 kurze Saetze und 2 laengere auf.",
        ),
        "names": (
            "Irene hoert Mateo zu und bittet Bianca dann, den Text zu pruefen.",
            "Luca, Gianni und Serena lesen abwechselnd, ohne den Ton zu aendern.",
            "Elisa trifft Fabio am Buecherregal und gibt ihm eine Mappe.",
            "Robert gruesst Anna, richtet das Mikrofon aus und versucht den Satz erneut.",
            "Clara und Simon waehlen ein klares Beispiel fuer den neuen Datensatz.",
        ),
        "punctuation": (
            "Sehr gut: Der Satz ist kurz, klar und gut gegliedert.",
            "Warte einen Moment, atme, und sprich dann natuerlich weiter.",
            "Es ist nicht noetig zu hetzen; klares und ruhiges Lesen ist besser.",
            "Wenn das Geraeusch lauter wird, stopp! Lies erst weiter, wenn der Raum ruhig ist.",
            "Hinweis: Satzzeichen fuehren den Rhythmus, sollen aber nicht als Text gelesen werden.",
        ),
    },
    "pt": {
        "short": (
            "A xicara fica na prateleira enquanto preparo a sala.",
            "Caminho devagar e mantenho a mesma distancia do microfone.",
        ...
        "medium": (
            "Cada gravacao deve ter um inicio limpo, uma frase completa e um final sem ruido.",
            "Se uma palavra parece dificil, digo com naturalidade em vez de aumentar muito o volume.",
            "O texto alterna descricoes simples, acoes do dia a dia e mudancas controladas de ritmo.",
            "Uma pausa curta entre duas ideias deixa a fala mais clara sem soar artificial.",
            "Leio com atencao, mas deixo a voz se mover de forma leve e natural.",
        ),
        "question": (
            "Voce quer repetir a frase se ouvir tosse ou ruido de papel?",
            "Esse tom combina com uma historia simples?",
            "Voce deixou silencio suficiente antes de comecar a falar?",
            "Podemos deixar a ultima palavra clara sem exagerar?",
            "O ritmo continua estavel quando a frase fica mais longa?",
        ),
        "numbers": (
            "No calendario marco 4 reunioes, 18 minutos de teste e 32 linhas lidas.",
            "O volume fica perto de 70%, e a distancia e de cerca de 20 centimetros.",
            "Preparo 5 cartoes, descarto 1 e guardo 14 exemplos uteis.",
            "O segundo clipe dura 42 segundos e inclui 6 pausas naturais.",
            "As 9:30 gravo 3 frases curtas e 2 mais longas.",
        ),
        "names": (
        ...
        "punctuation": (
            "Excelente: a frase e curta, clara e bem ritmada.",
            "Espere um segundo, respire e continue naturalmente.",
            "Nao precisa correr; e melhor ler bem e com calma.",
            "Se o ruido aumentar, pare! Continue apenas quando a sala estiver silenciosa.",
            "Nota: a pontuacao guia o ritmo, mas nao deve ser lida como texto.",
        ),
    },
    "pl": {
        "short": (
            "Kubek stoi na polce, gdy przygotowuje pokoj.",
            "Ide powoli i trzymam taka sama odleglosc od mikrofonu.",
            "Notes zawiera krotkie i uporzadkowane zapiski.",
            "Glos pozostaje miekki, nawet gdy zdanie przyspiesza.",
            "Zamykam drzwi cicho i wracam do czytania.",
        ),
        "medium": (
            "Kazde nagranie powinno miec czysty poczatek, pelne zdanie i koniec bez halasu.",
            "Jesli slowo wydaje sie trudne, wymawiam je naturalnie zamiast mocno podnosic glos.",
            "Tekst laczy proste opisy, codzienne czynnosci i kontrolowane zmiany rytmu.",
            "Krotka pauza miedzy dwiema myslami sprawia, ze mowa jest jasniejsza i nie brzmi sztucznie.",
            "Czytam uwaznie, ale pozwalam glosowi poruszac sie lekko i swobodnie.",
        ),
        "question": (
            "Czy chcesz powtorzyc zdanie, jesli slychac kaszel albo szelest?",
            "Czy ten ton pasuje do prostej opowiesci?",
            "Czy zostawiono dosc ciszy przed rozpoczeciem mowienia?",
            "Czy mozemy wyraznie wypowiedziec ostatnie slowo bez przesady?",
            "Czy rytm pozostaje staly, gdy zdanie staje sie dluzsze?",
        ),
        "numbers": (
            "W kalendarzu zaznaczam 4 spotkania, 18 minut proby i 32 przeczytane linie.",
            "Glosnosc zostaje blisko 70%, a odleglosc wynosi okolo 20 centymetrow.",
            "Przygotowuje 5 kart, odrzucam 1 i zostawiam 14 przydatnych przykladow.",
            "Drugi klip trwa 42 sekundy i zawiera 6 naturalnych pauz.",
            "O 9:30 nagrywam 3 krotkie zdania i 2 dluzsze.",
        ),
        "names": (
            "Irena slucha Mateusza, a potem prosi Bianke o sprawdzenie tekstu.",
            "Luca, Gianni i Serena czytaja po kolei bez zmiany tonu.",
            "Elisa spotyka Fabia przy regale i podaje mu teczke.",
            "Robert wita Anne, ustawia mikrofon i powtarza zdanie.",
            "Klara i Simon wybieraja jasny przyklad do nowego datasetu.",
        ),
        "punctuation": (
            "Bardzo dobrze: zdanie jest krotkie, jasne i rowno przeczytane.",
            "Poczekaj sekunde, wez oddech i kontynuuj naturalnie.",
            "Nie trzeba sie spieszyc; lepiej czytac wyraznie i spokojnie.",
            "Jesli halas wzrosnie, zatrzymaj sie! Kontynuuj dopiero w ciszy.",
            "Uwaga: interpunkcja prowadzi rytm, ale nie powinna byc czytana jako tekst.",
        ),
    },
    "tr": {
        "short": (
    ...
    "nl": {
        ...
        "numbers": (
            ...
            "Om 9:30 neem ik 3 korte zinnen en 2 langere zinnen op.",
        ),
        "names": (
    ...
    "cs": {
        "short": (
            "Hrnek zustava na polici, zatimco pripravuji mistnost.",
            "Jdu pomalu a drzim stejnou vzdalenost od mikrofonu.",
            "Zapisnik obsahuje kratke a usporadane poznamky.",
            "Hlas zustava mekky, i kdyz veta zrychli.",
            "Tise zavru dvere a znovu zacnu cist.",
        ),
        "medium": (
            "Kazda nahravka ma mit cisty zacatek, celou vetu a konec bez rusivych zvuku.",
            "Kdyz je slovo obtizne, vyslovim ho prirozene a nezvysuji prilis hlasitost.",
            "Text strida jednoduche popisy, bezne cinnosti a kontrolovane zmeny rytmu.",
            "Kratka pauza mezi dvema myslenkami zlepsi srozumitelnost, aniz by rec znela umele.",
            "Ctu pozorne, ale nechavam hlasu lehky a prirozeny pohyb.",
        ),
        "question": (
            "Chces vetu zopakovat, pokud uslysis kasel nebo susteni?",
            "Hodi se tento ton k jednoduchemu vypraveni?",
            "Nechal jsi dost ticha pred zacatkem reci?",
            "Muzeme posledni slovo vyslovit jasne a bez prehaneni?",
            "Zustava rytmus stejny, kdyz je veta delsi?",
        ),
        "numbers": (
            "V kalendari znacim 4 schuzky, 18 minut zkousky a 32 prectenych radku.",
            "Hlasitost zustava kolem 70% a vzdalenost je asi 20 centimetru.",
            "Pripravim 5 karet, 1 vyradim a necham 14 uzitecnych prikladu.",
            "Druhy klip trva 42 sekund a obsahuje 6 prirozenych pauz.",
            "V 9:30 nahravam 3 kratke vety a 2 delsi.",
        ),
        "names": (
            "Irena posloucha Matea a potom pozada Bianku o kontrolu textu.",
            "Luca, Gianni a Serena ctou postupne a nemeni ton.",
            "Elisa potka Fabia u knihovny a poda mu slozku.",
            "Robert pozdravi Annu, nastavi mikrofon a zkusi vetu znovu.",
            "Klara a Simon vyberou jasny priklad pro novy dataset.",
        ),
        "punctuation": (
            "Vyborne: veta je kratka, jasna a dobre rytmizovana.",
            "Pockej vterinu, nadechni se a potom prirozene pokracuj.",
            "Neni treba spechat; lepsi je cist zretelne a klidne.",
            "Pokud hluk zesili, zastav se! Pokracuj az v tichu.",
            "Poznamka: interpunkce vede rytmus, ale nema se cist jako text.",
        ),
    },
    "ar": {
        "short": (
    ...
    "hu": {
        "short": (
            "A bogre a polcon marad, amig elokeszitem a szobat.",
            "Lassan setalok, es ugyanazt a tavolsagot tartom a mikrofontol.",
            "A fuzetben rovid es rendezett jegyzetek vannak.",
            "A hang puha marad akkor is, amikor a mondat gyorsul.",
            "Csendben becsukom az ajtot, es ujra olvasni kezdek.",
        ),
        "medium": (
            "Minden felvetelnek tiszta kezdetre, teljes mondatra es zajmentes befejezesre van szuksege.",
            "Ha egy szo neheznek tunik, termeszetesen mondom ki, nem pedig tul hangosan.",
            "A szoveg egyszeru leirasokat, mindennapi cselekveseket es kontrollalt ritmusvaltasokat kever.",
            "Ket gondolat kozott egy rovid szunet erthetobbe teszi a beszedet, anelkul hogy mesterkelt lenne.",
            "Figyelmesen olvasok, de a hangnak konnyed es termeszetes mozgast hagyok.",
        ),
        "question": (
            "Megismetled a mondatot, ha kohogest vagy zizegest hallasz?",
            "Ez a hangnem illik egy egyszeru tortenethez?",
            "Hagytal eleg csendet, mielott beszelni kezdtel?",
            "Ki tudjuk mondani az utolso szot tisztan, tulzas nelkul?",
            "A ritmus stabil marad akkor is, amikor a mondat hosszabb lesz?",
        ),
        "numbers": (
            "A naptarban 4 talalkozot, 18 perc probat es 32 felolvasott sort jelolok.",
            "A hangerő 70% korul marad, a tavolsag pedig nagyjabol 20 centimeter.",
            "Elokeszitek 5 kartyat, 1-et felreteszek, es 14 hasznos peldat megtartok.",
            "A masodik klip 42 masodpercig tart, es 6 termeszetes szunetet tartalmaz.",
            "9:30-kor 3 rovid mondatot es 2 hosszabbat veszek fel.",
        ),
        "names": (
            "Irene Mateot hallgatja, majd megkeri Biancat, hogy ellenorizze a szoveget.",
            "Luca, Gianni es Serena felvaltva olvas, anelkul hogy hangnemet valtana.",
            "Elisa a konyvespolc mellett talalkozik Fabioval, es atad neki egy mappat.",
            "Robert udvozli Annat, beallitja a mikrofont, es ujra megprobalja a mondatot.",
            "Clara es Simon vilagos peldat valaszt az uj datasethez.",
        ),
        "punctuation": (
            "Nagyon jo: a mondat rovid, tiszta es jol tagolt.",
            "Varj egy masodpercet, vegyel levegot, majd folytasd termeszetesen.",
            "Nem kell sietni; jobb tisztan es nyugodtan olvasni.",
            "Ha a zaj erosodik, allj meg! Csak akkor folytasd, ha a szoba csendes.",
            "Megjegyzes: az irasjel a ritmust vezeti, de nem szabad szovegkent felolvasni.",
        ),
    },
    "ko": {
        "short": (
